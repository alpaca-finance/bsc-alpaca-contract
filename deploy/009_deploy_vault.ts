...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const CONFIG_ADDR = '0x442545909DB59E658ADC9a79430Ea3aEDBDfee5B';
  const BASE_TOKEN_ADDR = '0xCCaf3FC49B0D0F53fe2c08103F75A397052983FB'
  ...
  const EXACT_ETA = '1622109600';
  const DEBT_FAIR_LAUNCH_PID = '16';
