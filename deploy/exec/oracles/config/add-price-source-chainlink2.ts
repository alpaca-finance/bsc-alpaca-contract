...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const TOKEN0_SYMBOLS = ["WFTM"];
  const TOKEN1_SYMBOLS = ["USDC"];
  const AGGREGATORV3S = [["0xf4766552D15AE4d256Ad41B6cf2933482B0680dc", "0x2553f4eeb82d5A26427b8d1106C51499CBa5D99c"]];
