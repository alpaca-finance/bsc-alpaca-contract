...
import { WaultSwapWorker02, WaultSwapWorker02__factory } from "../../../../typechain";
...
export class WaultWorkerAdaptor implements IWorkerLike {
  private _worker: WaultSwapWorker02;
  ...
  constructor(
    ...
    this._worker = WaultSwapWorker02__factory.connect(_workerAddress, _signerOrProvider);
  ...
  public async validateConfig(
    ...
    try {
      ...
      >([
        ...
        { contract: this._worker, functionName: "wexMaster" },
      ...
      expect(workerWexMaster).to.be.eq(workerInfo.stakingTokenAt, "masterChef mis-config");
