...
contract DeltaNeutralVaultConfig is IDeltaNeutralVaultConfig, OwnableUpgradeable {
  ...
  error TooMuchFee(uint256 _depositFeeBps, uint256 _withdrawalFeeBps, uint256 _managementFeePerSec);
  ...
  function setFees(
    ...
    if (
      ...
      revert TooMuchFee(_newDepositFeeBps, _newWithdrawalFeeBps, _newManagementFeeBps);
    }
