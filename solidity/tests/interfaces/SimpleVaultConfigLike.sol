...
interface SimpleVaultConfigLike {
    ...
    function killFactor(address worker, uint256)
        external
        view
        returns (uint256);
    ...
    function rawKillFactor(address worker, uint256)
        external
        view
        returns (uint256);
    ...
    function setApprovedAddStrategy(address[] memory addStrats, bool ok)
        external;
    ...
    function setWhitelistedLiquidators(address[] memory callers, bool ok)
        external;
    ...
    function workFactor(address worker, uint256)
        external
        view
        returns (uint256);
