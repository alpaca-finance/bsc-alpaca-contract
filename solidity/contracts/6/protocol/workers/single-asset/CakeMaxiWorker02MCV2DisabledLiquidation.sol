...
/// @title CakeMaxiWorker02MCV2 is a worker for force closing positions on low liquidity pools to prevent bad debt from price impact.
contract CakeMaxiWorker02MCV2DisabledLiquidation is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker02 {
  /// ---- Libraries ----
  ...
  /// @notice Disabled liquidation. This should be used when force closing positions in low liquidity pools.
