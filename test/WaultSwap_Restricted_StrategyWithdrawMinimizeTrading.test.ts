...
describe("WaultSwapRestrictedStrategyWithdrawMinimizeTrading", () => {
  ...
  async function fixture() {
    ...
    mockWaultSwapBaseTokenWbnbV2Worker = (await MockWaultSwapWorker.deploy(
    ...
    strat = (await upgrades.deployProxy(WaultSwapRestrictedStrategyWithdrawMinimizeTrading, [
      router.address,
      wbnb.address,
    ...
    mockWaultSwapBaseTokenWbnbV2WorkerAsBob = MockWaultSwapWorker__factory.connect(
