...
describe("BiswapStrategyAddTwoSideOptimal", () => {
  ...
  let addTwoSides: BiswapStrategyAddTwoSidesOptimal;

  // Contract Signer
  let addTwoSidesAsBob: BiswapStrategyAddTwoSidesOptimal;
  ...
  const setupRestrictedTest = async () => {
    ...
    addTwoSides = (await upgrades.deployProxy(BiswapStrategyAddTwoSidesOptimal, [
      router.address,
      mockedVault.address,
  ...
  const setupContractSigner = async () => {
    // Contract signer
    addTwoSidesAsBob = BiswapStrategyAddTwoSidesOptimal__factory.connect(addTwoSides.address, bob);
