...
describe("BiswapStrategyPartialCloseMinimizeTrading", () => {
  ...
  /// Strategy instance(s)
  let strat: BiswapStrategyPartialCloseMinimizeTrading;
  ...
  async function fixture() {
    ...
    strat = (await upgrades.deployProxy(BiswapStrategyPartialCloseMinimizeTrading, [
      router.address,
    ...
    context("when maxLpTokenToLiquidate > LP from worker", async () => {
      it("should use all LP", async () => {
        ...
        await expect(
          ...
          .to.emit(strat, "LogBiswapStrategyPartialCloseMinimizeTrading")
          .withArgs(
            baseToken.address,
            farmingToken.address,
