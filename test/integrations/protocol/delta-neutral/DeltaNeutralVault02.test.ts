...
describe("DeltaNeutralVault", () => {
  ...
  let deltaVault: DeltaNeutralVault02;
  ...
  let deltaVaultAsAlice: DeltaNeutralVault02;
  let deltaVaultAsBob: DeltaNeutralVault02;
  let deltaVaultAsEve: DeltaNeutralVault02;
  ...
  async function fixture() {
    ...
    deltaVault = await deployHelper.deployDeltaNeutralVault02(deltaNeutral);
    ...
    deltaVaultAsAlice = DeltaNeutralVault02__factory.connect(deltaVault.address, alice);
    deltaVaultAsBob = DeltaNeutralVault02__factory.connect(deltaVault.address, bob);
    deltaVaultAsEve = DeltaNeutralVault02__factory.connect(deltaVault.address, eve);
  ...
  describe("#deploy", async () => {
    context("when deploy with wrong config", async () => {
      it("should revert", async () => {
        ...
        await expect(deployHelper.deployDeltaNeutralVault02(deltaNeutral)).to.revertedWith(
