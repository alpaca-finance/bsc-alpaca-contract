...
describe("Vault - BiswapWorker03", () => {
  ...
  let spookyWorker: BiswapWorker03;
  ...
  let spookyWorkerAsEve: BiswapWorker03;
  ...
  async function fixture() {
    ...
    spookyWorker = (await upgrades.deployProxy(BiswapWorker03, [
      vault.address,
      baseToken.address,
      masterChef.address,
      router.address,
    ...
    spookyWorkerAsEve = BiswapWorker03__factory.connect(spookyWorker.address, eve);
  }
